...
public class TrafficAreaAdapter extends AbstractThematicSurfaceAdapter<TrafficArea> {
    ...
    @Override
    public TrafficArea createObject(QName name, XMLReader reader) throws ObjectBuildException, XMLReadException {
    ...
    @Override
    public Element createElement(TrafficArea object, Namespaces namespaces, XMLWriter writer) throws ObjectSerializeException, XMLWriteException {
