...
public class OuterCeilingSurfaceAdapter extends AbstractBoundarySurfaceAdapter<OuterCeilingSurface> {
    ...
    @Override
    public OuterCeilingSurface createObject(QName name, XMLReader reader) throws ObjectBuildException, XMLReadException {
    ...
    @Override
    public Element createElement(OuterCeilingSurface object, Namespaces namespaces, XMLWriter writer) throws ObjectSerializeException, XMLWriteException {
