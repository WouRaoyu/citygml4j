...
@XMLElement(name = "FloorSurface", namespaceURI = CityGMLConstants.CITYGML_2_0_TUNNEL_NAMESPACE)
public class FloorSurfaceAdapter extends AbstractBoundarySurfaceAdapter<FloorSurface> {
    private final QName substitutionGroup = new QName(CityGMLConstants.CITYGML_2_0_TUNNEL_NAMESPACE, "_GenericApplicationPropertyOfFloorSurface");
    ...
    @Override
    public Element createElement(FloorSurface object, Namespaces namespaces, XMLWriter writer) throws ObjectSerializeException, XMLWriteException {
        return Element.of(CityGMLSerializerHelper.getTunnelNamespace(namespaces), "FloorSurface");
    }
