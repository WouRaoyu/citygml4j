...
public class TransactionAdapter implements ObjectBuilder<Transaction>, ObjectSerializer<Transaction> {
    ...
    @Override
    public Transaction createObject(QName name, XMLReader reader) throws ObjectBuildException, XMLReadException {
    ...
    @Override
    public Element createElement(Transaction object, Namespaces namespaces, XMLWriter writer) throws ObjectSerializeException, XMLWriteException {
