...
public class AppearanceAdapter extends AbstractAppearanceAdapter<Appearance> {
    ...
    @Override
    public Appearance createObject(QName name, XMLReader reader) throws ObjectBuildException, XMLReadException {
    ...
    @Override
    public Element createElement(Appearance object, Namespaces namespaces, XMLWriter writer) throws ObjectSerializeException, XMLWriteException {
