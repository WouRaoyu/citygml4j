...
public class EnergyPerformanceCertificationAdapter implements ObjectBuilder<EnergyPerformanceCertification>, ObjectSerializer<EnergyPerformanceCertification> {
    ...
    @Override
    public EnergyPerformanceCertification createObject(QName name, XMLReader reader) throws ObjectBuildException, XMLReadException {
    ...
    @Override
    public Element createElement(EnergyPerformanceCertification object, Namespaces namespaces, XMLWriter writer) throws ObjectSerializeException, XMLWriteException {
