...
public class BuildingUnitPartAdapter extends AbstractBuildingUnitAdapter<BuildingUnitPart> {
    ...
    @Override
    public BuildingUnitPart createObject(QName name, XMLReader reader) throws ObjectBuildException, XMLReadException {
        return new BuildingUnitPart();
    }

    @Override
    public Element createElement(BuildingUnitPart object, Namespaces namespaces, XMLWriter writer) throws ObjectSerializeException, XMLWriteException {
